...
from .forms import EditProfileForm,PostForm,EditProfileAdminForm,CommentForm
...
def follows(username):
	...
	return render_template('follows.html',user=user,endpoint='.follows',
		pagination=pagination,follows=follows,ftype='粉丝')
...
def followed(username):
	...
	return render_template('follows.html',user=user,endpoint='.follows',
		pagination=pagination,follows=follows,ftype='关注')
...
@main.route('/test')
def test():
	return render_template('test.html',test='123')